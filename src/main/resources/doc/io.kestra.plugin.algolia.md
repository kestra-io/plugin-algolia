...
Set `applicationId` to your Algolia application ID and `apiKey` to your Algolia Admin API Key (both required). Store secrets in [secrets](https://kestra.io/docs/concepts/secret) and set connection properties on each task.
